  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative h-40 md:h-56 w-full overflow-hidden">
        <Image src="/hero-handbook.jpg" alt="Employee handbook" fill className="object-cover" priority />
        <div className="absolute inset-0 bg-gradient-to-t from-background via-background/60 to-transparent" />
        <div className="absolute bottom-0 left-0 right-0 p-4 md:p-8">
          <h1 className="text-2xl md:text-3xl font-bold text-foreground">Employee Handbook</h1>
          <p className="text-muted-foreground mt-1">Policies, procedures, and everything you need to know</p>
        </div>
      </div>
