...
export const salesTechniques: SalesTechnique[] = [
  {
    ...
    description:
      "Instead of asking what someone is looking for, ask what brought them in today. This single shift moves the conversation from product-hunting to goal-understanding — and gives you everything you need to make a great recommendation. The customer walks away feeling heard, not sold to.",
    exactWords: '"Hey, welcome to Highlife! What brings you by today?"',
    whyItWorks:
      "Most customers don\'t arrive with a product name in mind — they arrive with a need. Sleep. Energy. Stress. A gift. A curiosity. When you uncover the need first, every recommendation you make lands as a solution rather than a pitch. You become an advisor, not a register.",
    whenToUse: "Every new customer interaction without exception — especially browsers, first-timers, and anyone who looks uncertain.",
    avoidWhen: "Regular customers who walk in with purpose and know exactly what they want. Read the room — respect their time and get them out efficiently.",
  },
  {
    id: "tech-2",
    name: "The Experience Check",
    category: "discovery",
    tagline: "Calibrate before you recommend",
    description:
      "Before recommending any product, gauge the customer\'s experience with the category. A first-timer and a veteran kratom user need completely different conversations — the same pitch delivered to both will fail one of them every time. One question eliminates that risk.",
    exactWords: '"Have you tried anything like this before, or is this more of a first time exploring?"',
    whyItWorks:
      "Pitching too advanced loses beginners. Pitching too basic insults experienced users and wastes their time. The experience check calibrates your entire approach in one natural question — and it signals that you\'re paying attention to them specifically, not running a script.",
    whenToUse: "Any customer heading toward delta, kratom, kanna, or hemp flower products. Also use when someone mentions a product by name you haven\'t heard them reference before.",
    avoidWhen: "Pure accessories purchases are generally safe to skip this on, unless the customer is buying glass and you haven\'t helped them before.",
  },
  {
    id: "tech-3",
    ...
    description:
      "Customers don\'t want to understand cannabinoid profiles or alkaloid chains — they want to know if something will actually work for their life. Ask about context and timing, not chemistry. Their answer maps directly to a product recommendation every time.",
    exactWords:
      '"Is this more for like winding down after work, getting through a long day, or something for the weekend?"',
    whyItWorks:
      "Context answers all questions: evening decompression points to red kratom or indica-leaning delta; daytime productivity points to green kratom, sativa-leaning delta, or kanna; social or creative use points to kanna or hybrid delta; sleep support points to higher-dose indica edibles or red kratom. One lifestyle question eliminates the entire guesswork.",
    whenToUse: "Any customer who seems open to guidance, is browsing without direction, or says \'I\'m not sure what I want.\'",
    avoidWhen: "Customers who already know their product, strain, or format by name. Don\'t slow down a confident buyer.",
  },
  {
    id: "tech-4",
    ...
    description:
      "When a customer flinches at a price, don\'t defend it — reframe it. Break the product down to its cost per use. A $45 jar sounds steep; $1.50 per session for four-to-six hours of effect does not. The math is always on your side — you just have to do it out loud.",
    exactWords:
      '"I totally get it — first look it does seem like a lot. But if you break it down, each gummy is about a dollar fifty, and each one lasts you four to six hours. That\'s less than a coffee for an evening of real relief."',
    whyItWorks:
      "Sticker shock is a comparison problem — the brain sees a large number with nothing to benchmark against. Per-use math gives the brain a fair, real comparison. Once the number shrinks to a per-use figure, premium products routinely become the obvious choice.",
    whenToUse: "Any price hesitation on gummies, capsules, tinctures, or mid-to-high-end glass. This works especially well when the customer is comparing to a cheaper product.",
    avoidWhen: "Low-cost impulse items — keep those fast. Per-use math is for anything over $25.",
  },
  {
    id: "tech-5",
    name: "The One Honest Upsell",
    category: "upsell",
    tagline: "One add. Genuine. Never stacked.",
    description:
      "The best upsell feels like a helpful heads-up, not a pitch. At the register, mention exactly one logical addition — framed as something the customer will actually want to have. The framing matters as much as the product. Make it sound like you\'re doing them a favor, because you are.",
    exactWords:
      '"Oh — did you want to grab a battery for that? I always forget to mention it before people leave. That cart won\'t work without one and we have a good one right here."',
    whyItWorks:
      "\'I always forget to mention\' is conversational, not scripted. It removes the sales pressure and makes the suggestion feel spontaneous and genuine. The customer who leaves without the battery comes back annoyed. The customer who leaves with it comes back satisfied. Every genuine upsell is a trust deposit.",
    whenToUse: "At checkout, after the primary product is confirmed. One pairing per transaction: vape cart → battery, glass → cleaning solution, kratom powder → measuring scoop or capsule machine, flower → grinder or papers.",
    avoidWhen: "Never stack upsells. One and only one. Multiple suggestions at checkout feel like a trap and undo the trust you built during the consultation.",
  },
  {
    id: "tech-6",
    name: "The Two-Option Close",
    category: "close",
    tagline: "Turn browsing into a decision",
    description:
      "When a customer has been weighing options for more than a couple of minutes, they\'ve entered decision paralysis. The fix is to remove all options except two — both of which are good — and frame the choice clearly. You\'re not pushing them to buy; you\'re making it easier to decide.",
    exactWords:
      '"Okay so it really comes down to this — do you want the one that works faster with the vape, or the one that lasts longer with the gummy? Either way you\'re getting a great product."',
    whyItWorks:
      "Unlimited options freeze buyers. Two clear options, both genuinely good, make the decision feel safe and manageable. The customer gets to feel like they made an informed choice — because they did. The framing \'either way you\'re getting a great product\' removes fear of making the wrong call.",
    whenToUse: "When a customer has been visibly comparing products for two or more minutes, or has asked the same clarifying question more than once.",
    avoidWhen: "Don\'t deploy this before they\'ve had a real conversation — they\'ll feel steamrolled. Discovery comes first, close comes last.",
  },
  {
    id: "tech-7",
    name: "The Kanna Introduction",
    category: "recommendation",
    tagline: "Lead with the story, close with the benefit",
    description:
      "Kanna is unknown to nearly every customer who walks in. The fastest path to a sale is a tight historical hook followed immediately by the one benefit most relevant to what they just told you they need. Keep it short, keep it specific, and always transition to the SSRI screen before any product changes hands.",
    exactWords:
      '"So this one is actually really cool — it\'s called Kanna. It\'s a plant from South Africa that\'s been used for thousands of years. No THC, no caffeine — people describe it as smooth, focused energy with a mood lift. Basically calm without being sedated."',
    whyItWorks:
      "The history establishes credibility immediately — this isn\'t some new supplement someone invented last year. The \'no THC, no caffeine\' framing pre-empts the two most common concerns before they\'re voiced. And the effect description is specific enough to click for the right customer without overpromising.",
    whenToUse: "Any customer who mentions stress, anxiety, caffeine reliance, wanting to cut back on THC, needing focus without a crash, or wanting a non-intoxicating wellness option.",
    avoidWhen: "SSRI screen must happen before any sale — if the customer discloses SSRIs or SNRIs at any point, stop the Kanna sale immediately. See compliance notes.",
  },
  {
    id: "tech-8",
    name: "The First-Timer Safety Net",
    category: "recommendation",
    tagline: "Protect them from a bad first experience",
    description:
      "The single most important thing you can do for a first-time edible customer is give them the dosage guidance they didn\'t know they needed. Half a gummy, two-hour wait. Say it clearly. Say it at the start and say it again at the close. This conversation protects the customer and it protects the store.",
    exactWords:
      '"Honestly the most important thing with edibles is start with half. I know it feels like not enough, but half is where most people find their sweet spot the first time — especially with delta. You can always take more. You absolutely cannot take less. And wait the full two hours before you decide if it\'s working."',
    whyItWorks:
      "A customer who has a great first experience becomes a regular and tells their friends. A customer who overconsumes never comes back and tells their friends that too. The safety net is the highest-ROI conversation in this store. It also builds a level of trust no other technique can match — you are visibly protecting them over making a sale.",
    whenToUse: "Every first-time edible, gummy, or capsule customer, no exceptions. Even if they seem confident — this information lands every time.",
    avoidWhen: "Experienced users who clearly know their dose. Telling a regular what they already know is condescending. Read the cues.",
  },
  {
    id: "tech-9",
    name: "The Hemp Flower Pivot",
    category: "recommendation",
    tagline: "Recognize the dispensary customer and meet them where they are",
    description:
      "When a customer mentions they\'re used to dispensary cannabis or comes in asking for something \'like the real thing,\' pivot directly to THCA hemp flower. This customer segment responds poorly to edibles as a starting point — they want the flower experience, and we have it. Know your strains, know your formats, and speak their language.",
    exactWords:
      '"If you\'re used to actual flower from a dispensary, honestly the THCA flower is what you want to look at. It\'s indoor-grown, it smokes exactly like what you\'re used to — because chemically, after you light it, it\'s essentially the same thing. What kind of effect are you going for — something more energizing or more relaxing?"',
    whyItWorks:
      "Cannabis consumers have calibrated palates and calibrated expectations. Sending them home with a gummy when they wanted flower is a mismatch that loses the sale and the customer. Speaking their language directly — \'it\'s indoor-grown,\' \'smokes the same,\' \'after you light it the chemistry is identical\' — signals that you know your product and they can trust your recommendation.",
    whenToUse: "Any customer who mentions dispensaries, \'real\' cannabis, specific strains they prefer, or who seems experienced with cannabis and is browsing the delta section.",
    avoidWhen: "Never lead with flower for a customer who has expressed nervousness or has no prior cannabis experience — start them on delta-8 edibles first.",
  },
  {
    id: "tech-10",
    name: "The Kratom Coffee Bridge",
    category: "recommendation",
    tagline: "Make the unfamiliar feel familiar",
    description:
      "Most kratom-curious customers arrive with skepticism shaped by negative press and no frame of reference. The fastest way to reset their mental model is the coffee comparison. Once you\'ve done that, the vein color system maps everything else cleanly. This technique turns a skeptical browser into a confident buyer in under two minutes.",
    exactWords:
      '"So kratom is in the same plant family as coffee — the effects are actually pretty similar. Green vein is like a smooth, focused energy; red vein is more like winding down at the end of the day; white vein is the most stimulating. For where you\'re starting, I\'d point you toward green — it\'s the most balanced and consistently the best intro."',
    whyItWorks:
      "Coffee is a universal reference point with no stigma. Framing kratom as a botanical cousin of coffee immediately normalizes it. The three-color system is instantly memorable and maps to three clear use cases — customers retain it and come back asking for the right thing.",
    whenToUse: "Any kratom-curious customer who seems unfamiliar with it, skeptical, or is asking what it is. Also effective with customers who\'ve heard \'bad things\' and need context.",
    avoidWhen: "Veteran kratom users who know their strains — they don\'t need the introduction, they need specific strain knowledge.",
  },
]
...
export const rolePlayScenarios: RolePlayScenario[] = [
  {
    ...
    difficulty: "beginner",
    scenario:
      "A customer in their mid-20s is browsing the delta section looking slightly uncertain. They haven\'t been approached yet.",
    goal: "Confirm their experience level, set proper expectations, guide them to the right starter product, and deliver the two-hour safety instruction clearly.",
    lines: [
      { speaker: "employee", text: "Hey, welcome to Highlife! What brings you by today?", note: "Always open with \'what brings you by\' — not \'can I help you.\' One question tells you everything you need." },
      { speaker: "customer", text: "Yeah, I\'ve been looking at these gummies. My friend swears by them but I\'ve never tried anything like this." },
      { speaker: "employee", text: "Oh nice — your friend has good taste. Is this your first time with delta products or anything like that?", note: "Confirm experience before recommending anything. Never assume." },
      { speaker: "customer", text: "Yeah, totally first time. I\'m honestly a little nervous." },
      { speaker: "employee", text: "That\'s completely normal — and it\'s actually a good sign that you\'re thinking about it before jumping in. The most important thing is starting low. For a first timer I\'d point you to the Delta-8s — they\'re 25mg each, but I always tell people to start with half. Delta-8 is a gentler intro than D9, so it\'s a much more manageable first experience.", note: "Reassure + guide down to the appropriate product. Never upsell a first-timer to the stronger option. The gentler intro protects them and builds their trust in you." },
      { speaker: "customer", text: "Okay. How long does it take to kick in?" },
      { speaker: "employee", text: "Edibles take anywhere from 45 minutes to two hours depending on your metabolism and whether you\'ve eaten. The single most common mistake people make is taking more because they think it\'s not working. Please wait the full two hours before you take anything else.", note: "The two-hour wait is the most critical piece of safety information for any edible customer. Deliver it clearly and directly — not as a suggestion." },
      { speaker: "customer", text: "Okay, good to know. What about these Delta-9 ones over here — are those different?" },
      { speaker: "employee", text: "Delta-9 is a stronger experience — it\'s a great product, but I\'d really start with the Delta-8 to see how your body responds first. Once you know your dose there, D9 is a natural next step. No need to jump straight to the deep end.", note: "Hold the line on Delta-8 for first-timers. Protecting the customer from a negative first experience is more valuable than the slightly higher ticket." },
      { speaker: "customer", text: "Makes sense. Okay, I\'ll go with the Delta-8." },
      { speaker: "employee", text: "Good call. Enjoy it — half to start, wait the two hours. You\'re going to have a great time.", note: "Reinforce the dosage instruction at close. Say it twice — at first introduction and at checkout." },
    ],
    keyTakeaways: [
      "Always confirm experience level before recommending any product",
      "Delta-8 is the correct starting point for first-timers — never upsell to D9 on a first visit",
      "The two-hour wait instruction is non-negotiable — say it clearly, say it twice",
      "Half a gummy for first-timers is the universal standard recommendation",
    ],
  },
  {
    id: "rp-2",
    ...
    difficulty: "beginner",
    scenario:
      "A customer is looking at a $45 tin of kratom capsules and visibly hesitates after seeing the price tag.",
    goal: "Acknowledge the hesitation without defensiveness, use per-dose math to reframe the value, and close on the right size for the customer.",
    lines: [
      { speaker: "customer", text: "Forty-five dollars? That\'s kind of a lot for this." },
      { speaker: "employee", text: "Yeah, first look it does feel steep — I get it. What size are you looking at?", note: "Acknowledge without defending. Then ask a clarifying question. Never lead with justification." },
      { speaker: "customer", text: "The 120-count one." },
      { speaker: "employee", text: "Okay so 120 capsules at 500mg each. Most people dose between 4 and 8 capsules per session — so you\'re getting somewhere between 15 and 30 uses out of that jar. That breaks down to between $1.50 and $3 per session.", note: "Do the math out loud, casually — not like a sales pitch. Let the number land." },
      { speaker: "customer", text: "Huh. I hadn\'t actually thought about it that way." },
      { speaker: "employee", text: "Yeah it\'s one of those things where the jar price is the number that hits first, but stretched across uses it\'s actually pretty solid. And these are third-party tested — COA is on the QR code right on the label. That matters a lot with kratom, especially buying online where you can\'t verify that.", note: "Lab testing is a meaningful differentiator. Offer it as a point of confidence, not a sales hook." },
      { speaker: "customer", text: "Is there a smaller option?" },
      { speaker: "employee", text: "Yeah — we\'ve got the 60-count for about $26. Honestly if you haven\'t tried this particular strain before, that\'s actually the smarter move. Try it, find your dose, and then if you like it we can set you up with the bigger jar next time.", note: "Offer the smaller size genuinely. Never push the bigger size on a customer who\'s still on the fence — the trust you build with this recommendation is worth more than the $19 difference." },
      { speaker: "customer", text: "Yeah, let\'s do the 60." },
      { speaker: "employee", text: "Smart call. If it works for you — and it usually does — the 120 is actually a better deal per capsule when you come back.", note: "Plant the future upsell naturally and with no pressure. It lands as a useful piece of information, not a sales pitch." },
    ],
    keyTakeaways: [
      "Never be defensive about price — acknowledge and pivot immediately to per-dose math",
      "Per-dose math is the single most effective tool for price objections",
      "Offering the smaller size builds trust — it signals you\'re on the customer\'s side",
      "Lab testing and COAs are quality differentiators that justify the price gap versus online competitors",
    ],
  },
  {
    id: "rp-3",
    ...
    scenario:
      "A health-conscious customer asks if you carry anything for stress and focus that isn\'t cannabis or a stimulant. They seem genuinely curious.",
    goal: "Introduce Kanna using the history-hook, complete the SSRI screen naturally, and close on the right format with accurate onset expectations.",
    lines: [
      { speaker: "customer", text: "Do you guys have anything for stress and focus? I don\'t want anything THC and I\'m trying to cut back on caffeine." },
      { speaker: "employee", text: "Actually yes — have you ever heard of Kanna?", note: "Lead with a question, not a product name. Curiosity is the most effective opener for an unknown product." },
      { speaker: "customer", text: "No, I haven\'t. What is that?" },
      { speaker: "employee", text: "So Kanna is a plant from South Africa — it\'s been used for thousands of years, it\'s non-THC, no caffeine. People describe it as smooth, focused energy with a mood lift. Not sedating, not wired — kind of like being at your best without any edge to it. Honestly one of my favorite things we carry.", note: "Historical hook first — it establishes legitimacy. Then the benefit in one sentence. Personal endorsement adds authenticity without being salesy." },
      { speaker: "customer", text: "That sounds interesting. Is it similar to CBD?" },
      { speaker: "employee", text: "It works differently than CBD — Kanna works on serotonin pathways, so the effects are usually more noticeable and consistent. A lot of people who felt like CBD didn\'t do much for them find Kanna is way more impactful. CBD and Kanna are in completely different families.", note: "Distinguish from CBD honestly without being dismissive of it. The serotonin pathway detail is factual and creates a meaningful separation from CBD." },
      { speaker: "customer", text: "Interesting. What does it come in?" },
      { speaker: "employee", text: "Two main formats — gummies, which are great for sustained focus and all-day support, and a snuff form that hits faster if you want something more immediate. Which sounds more like what you\'re after?", note: "Present two options and let the customer choose direction. Don\'t preselect for them yet." },
      { speaker: "customer", text: "Probably the gummies." },
      {
        speaker: "employee",
        text: "Perfect — before I grab those, one thing I always check with Kanna: are you currently on any antidepressants or mood medications? SSRIs, SNRIs, anything like that?",
        note: "CRITICAL — the SSRI screen must happen before any Kanna sale. Ask it matter-of-factly, not as a big deal. It should feel like a standard intake question.",
      },
      { speaker: "customer", text: "No, I\'m not on anything like that." },
      { speaker: "employee", text: "Great — just something we check with this one. So for the gummies: start with one, take it whenever you want that focus window. Give it 45 minutes to an hour and a half to fully come on — don\'t judge it in the first 30 minutes. It lasts three to five hours.", note: "Clear onset expectations prevent \'it didn\'t work\' follow-up complaints. Be specific." },
      { speaker: "customer", text: "That sounds exactly like what I was looking for." },
      { speaker: "employee", text: "I think you\'ll really like it. Come back and let me know — most people are genuinely surprised." },
    ],
    keyTakeaways: [
      "Lead with the historical hook — it creates credibility and makes Kanna feel legitimate",
      "The SSRI screen is non-negotiable — phrase it naturally as a standard check",
      "Distinguish Kanna from CBD without talking down CBD — they\'re different categories entirely",
      "Give accurate onset expectations: 45–90 minutes for gummies, not \'it works right away\'",
    ],
  },
  {
    id: "rp-4",
    ...
    difficulty: "intermediate",
    scenario:
      "A customer has seen kratom content online and is curious but skeptical. They want to understand what it actually is before committing.",
    goal: "Establish credibility with the coffee comparison, match them to the right vein color for their need, give specific dosing guidance, and close on a starter size.",
    lines: [
      { speaker: "customer", text: "I keep seeing kratom online. What actually is it — is it like some sketchy supplement?" },
      {
        speaker: "employee",
        text: "Not at all — it\'s actually in the same plant family as coffee, botanically. It\'s been used for centuries in Southeast Asia. The big thing that trips people up is that different vein colors do really different things.",
        note: "Coffee comparison immediately normalizes kratom and removes the \'sketchy supplement\' stigma. Lead with it every time.",
      },
      { speaker: "customer", text: "Oh interesting. What do the different colors mean?" },
      { speaker: "employee", text: "Think of it like a traffic light. Green vein is the most balanced — smooth energy, mood lift, closest to a good cup of coffee but without the crash. Red vein is the relaxing end — most people use that in the evening to wind down. White vein is the most stimulating, but I usually steer beginners away from that one to start.", note: "Three colors, three use cases. Keep it this simple — customers remember it and come back asking for the right thing." },
      { speaker: "customer", text: "I\'m mostly looking for something to help me focus and have better energy at work during the day." },
      { speaker: "employee", text: "That\'s a textbook green vein situation. Our Green Maeng Da is our best seller for exactly that reason — it\'s potent, consistent, and the effects are that balanced energy-and-mood combo without going overboard. That\'s where I\'d start you.", note: "Make a specific recommendation with a reason. Don\'t list options — commit to one. Confident recommendations close sales; menus create paralysis." },
      { speaker: "customer", text: "How do you take it?" },
      { speaker: "employee", text: "Comes in powder — the most common way is toss and wash, where you measure it out, put it in your mouth, and wash it down with water or juice. Fair warning: the taste is an acquired one. If you\'d rather skip the flavor, we have capsules — same product, just easier to take.", note: "Be upfront about the taste. Customers who are surprised by it have bad first experiences. Honesty here = repeat customers." },
      { speaker: "customer", text: "How much should I actually take?" },
      { speaker: "employee", text: "Start at 1 to 2 grams. Take it on an empty stomach if you can — you\'ll feel it within 20 to 30 minutes. Most people land at 2 to 4 grams for their sweet spot, but you want to find your baseline first. With kratom, more is not always better — at higher doses the effects invert and you just feel sedated.", note: "Specific dosing guidance is essential. Vague advice = overconsumption = bad experiences = lost customers. The \'effects invert at high doses\' note is important context that educated buyers appreciate." },
      { speaker: "customer", text: "What size should I start with?" },
      { speaker: "employee", text: "For a first time, the 25 or 50 gram is the right call — just enough to find your dose without committing to a big jar before you know you like it. Once you\'ve dialed it in, the larger sizes give you a much better price per gram.", note: "Recommend the starter size for first-timers. Trust over ticket size. The customer who has a great first experience comes back for the big jar." },
    ],
    keyTakeaways: [
      "The coffee comparison is your most effective tool for kratom-curious skeptics",
      "Three vein colors, three use cases — keep it simple and memorable",
      "Always give specific dosing guidance — \'start with 1-2 grams\' is better than \'start low\'",
      "Recommend the starter size for first-timers — trust builds the long-term customer",
    ],
  },
  {
    id: "rp-5",
    title: "The Kanna + Delta Upsell — with the SSRI Hard Stop",
    category: "upsell",
    difficulty: "intermediate",
    scenario:
      "A returning customer is picking up their usual Delta-8 gummies. In a previous visit they mentioned sometimes getting anxious from edibles.",
    goal: "Reference their past concern, introduce the Kanna + Delta combo as the specific solution, complete the SSRI screen, and demonstrate the correct response when the screen fails.",
    lines: [
      { speaker: "customer", text: "Hey — just grabbing my usual Delta-8 gummies." },
      { speaker: "employee", text: "Of course. Actually — before I ring those up, can I show you something? You mentioned last time that edibles sometimes make you a little anxious. Is that still happening?", note: "Referencing a previous conversation shows you listen and builds real rapport. This is the foundation of the upsell — start with their problem, not a product." },
      { speaker: "customer", text: "Yeah honestly, it\'s hit or miss. Sometimes it\'s fine, sometimes I get a little edgy." },
      { speaker: "employee", text: "So we got something in that I think might actually fix that. It\'s a gummy that combines Delta-9 with Kanna — and what Kanna does is it literally modulates the anxiety pathway that THC can trigger. People who normally get edgy from edibles almost universally report a cleaner, smoother experience with this combo.", note: "Lead with the problem it solves, not the product. Problem first, product second — always." },
      { speaker: "customer", text: "Is it stronger than what I\'m already taking?" },
      { speaker: "employee", text: "It\'s 10mg Delta-9 per gummy — slightly more than the Delta-8 on paper. But the Kanna smooths the experience out, so people don\'t typically feel \'more high,\' they just feel better. Less edgy, more settled.", note: "Address the strength concern honestly. Don\'t minimize the potency, but explain why the experience will likely feel better rather than more intense." },
      { speaker: "customer", text: "Does it last longer?" },
      { speaker: "employee", text: "Yeah — the Kanna extends the window, so you\'re looking at four to six hours versus the usual three to four with straight Delta-8. Longer and smoother.", note: "Duration is a genuine value add. State it factually." },
      { speaker: "customer", text: "Okay I\'m pretty much sold. Oh — I\'m actually on Zoloft. Does that matter?" },
      {
        speaker: "employee",
        text: "I\'m really glad you mentioned that. I can\'t sell you the Kanna product if you\'re on an SSRI — Zoloft is one of them. The Kanna alkaloids interact with SSRIs in a way that can actually cause problems. I\'d stick with your regular Delta-8 for now, and if you want to explore Kanna down the road, that\'s a conversation to have with your doctor first.",
        note: "CRITICAL STOP. This is the correct response, every time, no exceptions. Do not sell Kanna to anyone on SSRIs even if they insist, even if they\'re only \'on a low dose,\' even if they say they\'ll be fine. Patient safety is not negotiable. Walk away from the sale and the customer will respect you for it.",
      },
      { speaker: "customer", text: "Oh wow — I had no idea. Thank you for catching that." },
      { speaker: "employee", text: "Of course. That\'s exactly why we check. Let\'s get you your usual Delta-8 — and we\'ll keep an eye out for any non-Kanna combos that might work for the anxiety piece too.", note: "Close the interaction warmly and forward-looking. The customer leaves feeling protected, not rejected." },
    ],
    keyTakeaways: [
      "Reference previous conversations — it signals that you actually listen, not just transact",
      "Lead upsells with the problem they solve, not the product name",
      "The SSRI screen must happen mid-upsell, not just at the start of Kanna conversations",
      "Walking away from a Kanna sale when an SSRI is disclosed is the right move — do it without hesitation",
    ],
  },
  {
    id: "rp-6",
    ...
    difficulty: "advanced",
    scenario:
      "A customer walks in using non-compliant terminology for glass and asks to combine transactions. A compliance inspector makes unannounced visits.",
    goal: "Redirect terminology naturally without making the customer feel corrected, and handle the glass/papers separation policy calmly and clearly.",
    lines: [
      { speaker: "customer", text: "Hey — do you have any good bongs? I want something that hits hard for weed." },
      {
        speaker: "employee",
        text: "Hey, welcome in! Absolutely — our water pipes are really solid right now. Let me show you a few things.",
        note: "Do NOT say \'we don\'t use that word here\' or anything that makes the customer feel corrected. Just use the correct term naturally in your response and move forward. The customer will follow your lead.",
      },
      { speaker: "customer", text: "Nice. I want something that filters well — it\'s for smoking weed so I want really smooth hits." },
      {
        speaker: "employee",
        text: "This one is excellent for tobacco — borosilicate glass, diffused downstem for maximum filtration, and the ice catcher up top makes a noticeable difference. It\'s one of our best performers.",
        note: "\'For tobacco\' is your phrase every time. Do not engage with or acknowledge \'weed.\' Keep the conversation moving naturally.",
      },
      { speaker: "customer", text: "Perfect. Can I also grab some of those hemp wraps while I\'m here?" },
      {
        speaker: "employee",
        text: "Of course — we have rolling papers and wraps right over here. I do need to run that as a separate transaction from the water pipe.",
        note: "COMPLIANCE: Glass and rolling papers/wraps cannot be sold in the same transaction. State it matter-of-factly without making a big deal of it.",
      },
      { speaker: "customer", text: "Why? Can\'t you just add it to the same receipt?" },
      {
        speaker: "employee",
        text: "It\'s a store policy we follow — we have to ring those separately. Easiest way is I complete the water pipe for you now, then you just step outside for a moment and come right back in and I\'ll grab the wraps. Takes like 30 seconds.",
        note: "Explain the separation clearly and without awkwardness. Do not say why the policy exists. Do not be apologetic about it — it\'s a standard procedure and should be delivered as one.",
      },
      { speaker: "customer", text: "That\'s a little weird but sure, okay." },
      { speaker: "employee", text: "Appreciate your patience with it — it\'s just how we operate. Let\'s get the water pipe sorted first.", note: "Acknowledge the mild inconvenience without over-apologizing. Keep it moving." },
    ],
    keyTakeaways: [
      "Never correct a customer\'s terminology directly — just use the correct term in your own response and move on",
      "\'For tobacco\' is the phrase for all glass and paper products — use it every time, no exceptions",
      "Glass and rolling papers cannot be in the same transaction — the customer must exit the store between the two",
      "Treat every customer interaction as if a compliance inspector is watching — because occasionally one is",
    ],
  },
  {
    id: "rp-7",
    ...
    difficulty: "advanced",
    scenario:
      "A customer is eyeing a heady piece priced at $400 but keeps comparing it mentally to the scientific glass at $65. They need to understand why the categories aren\'t comparable.",
    goal: "Get the piece in their hands, tell the story behind the artistry, close on value and uniqueness — never on price.",
    lines: [
      { speaker: "customer", text: "These heady ones are really cool but... four hundred dollars for a pipe? That\'s a lot." },
      {
        speaker: "employee",
        text: "It is a number. Can I actually let you hold it for a second before we talk about anything else?",
        note: "Get it in their hands immediately. Tactile connection is the #1 closing tool for heady glass — nothing else comes close. Don\'t explain the price before they\'ve held it.",
      },
      { speaker: "customer", text: "(holds it) Okay — this actually feels incredible. The weight, the glass..." },
      { speaker: "employee", text: "Right? So this is hand-blown by an American artist — this specific piece probably took several hours to make. And the thing that matters: there is not another one of these anywhere in the world. This is the only one.", note: "One-of-a-kind is the single most powerful differentiator for heady glass. Say it clearly. The customer is no longer comparing it to a $65 scientific piece — they\'re comparing it to nothing." },
      { speaker: "customer", text: "What\'s the color technique? How does it do that?" },
      { speaker: "employee", text: "That\'s silver fuming — the artist literally vaporizes silver into the glass as it\'s being formed. The color shifts with the viewing angle, and it actually deepens over time as it gets used. A year from now this piece will look different than it does today.", note: "Know the technique and explain it. The narrative is what closes heady sales. Customers want to feel like they understand what they\'re buying — the story delivers that." },
      { speaker: "customer", text: "Is it actually functional though, or is it more of a display thing?" },
      { speaker: "employee", text: "Completely functional — for tobacco use. The airflow is dialed in really well, the base is stable, and the downstem geometry is right. It\'s not just art, it\'s a great piece to use.", note: "\'For tobacco use\' — every time, even on heady glass. Never miss this. Then immediately validate that it works well." },
      { speaker: "customer", text: "What\'s the return policy on something like this?" },
      { speaker: "employee", text: "Glass is final sale. But honestly — heady pieces don\'t come back. People who buy them keep them. And some of our customers have picked up pieces over the years that are now worth more than they paid. It\'s a different category of purchase.", note: "Reframe \'no returns\' as a signal of quality and collectibility. Don\'t apologize for the policy. Own it." },
      { speaker: "customer", text: "Alright. I\'m going to do it." },
      { speaker: "employee", text: "Great choice. I always double-box heady pieces — I\'ll make sure it\'s wrapped really well. You\'re going to love it.", note: "The care in packaging is part of the premium experience. It reinforces that the customer made the right call." },
    ],
    keyTakeaways: [
      "Get heady glass in the customer\'s hands before anything else — tactile connection is the close",
      "One-of-a-kind and handmade-by-an-artist are the only value propositions that justify the price gap",
      "Know at least three glass techniques: silver fuming, millie work, dichroic, UV-reactive",
      "\'For tobacco use\' applies in every glass conversation, including heady pieces",
    ],
  },
]
...
export const objectionCards: ObjectionCard[] = [
  {
    ...
    wrongResponse: '"Well it\'s really high quality..." or getting defensive and explaining overhead.',
    rightResponse:
      '"Totally fair first reaction — can I show you something real quick? At 120 capsules, each one is about $1.50 per use. Most supplements and even energy drinks cost more per dose than that. And you\'re getting four to six hours out of each one."',
    whyItWorks:
      "Defending a price sounds like an excuse and puts you on opposite sides. Acknowledging the reaction and immediately pivoting to per-dose math keeps the conversation collaborative. The customer gets a fair comparison, and the math almost always wins.",
  },
  {
    id: "obj-2",
    category: "hesitation",
    objection: '"I need to think about it."',
    wrongResponse: '"Okay, no problem!" — and letting them walk out the door.',
    rightResponse:
      '"Of course, no pressure at all. Is there one specific thing I can clear up that might help? A lot of times there\'s just one question underneath that, and once it\'s answered it clicks."',
    whyItWorks:
      "\'I need to think about it\' almost always means \'there\'s one thing I\'m not sure about yet.\' One gentle question surfaces it without feeling pushy. If they genuinely need time after that, respect it — a customer who leaves without pressure almost always comes back. A customer who feels cornered doesn\'t.",
  },
  {
    id: "obj-3",
    category: "product",
    objection: '"Will this actually work for me? I\'ve tried things before that didn\'t."',
    wrongResponse: '"Oh yeah, this one definitely works — everyone loves it." (overclaiming)',
    rightResponse:
      '"Honestly, that\'s a fair thing to ask. What did you try before and what didn\'t work about it? If I know that, I can usually figure out why it missed and get you pointed in the right direction."',
    whyItWorks:
      "Overclaiming creates a compliance risk and destroys trust the moment the product doesn\'t match the hype. Honest curiosity about their past experience gives you exactly what you need to make a better recommendation — and it positions you as someone who\'s actually trying to solve their problem, not just close a sale.",
  },
  {
    id: "obj-4",
    category: "competitor",
    objection: '"I can get this same thing cheaper online."',
    wrongResponse: '"We have to charge more because of overhead." (weak, sounds apologetic)',
    rightResponse:
      '"You absolutely can — and some of what\'s online is legit. What I can tell you is everything we carry is third-party tested and I can pull up the COA right now if you want to check it. You also get to see exactly what you\'re getting, ask me anything, and come back if something\'s not right. That\'s just not something you get from a website."',
    whyItWorks:
      "Price competition with online retail is unwinnable — don\'t play that game. The winning play is service, accountability, and transparency. These are genuine advantages that no website can replicate. Lead with the COA offer — it signals confidence in product quality and immediately shifts the comparison to what matters.",
  },
  {
    id: "obj-5",
    category: "hesitation",
    objection: '"I\'m worried about failing a drug test."',
    wrongResponse: '"Oh you\'ll be fine, it\'s hemp so it won\'t show up."',
    rightResponse:
      '"That\'s a completely valid concern and I\'m not going to minimize it. Delta products and kratom can absolutely show up on standard drug tests. If you\'re in a testing window or you test regularly for work, I\'d honestly recommend waiting. Your job isn\'t worth the risk."',
    whyItWorks:
      "This is one of the highest-stakes moments in this store. If you wave this off and they fail a test, you\'ve done real harm to a real person and likely lost them forever. Honest guidance — even when it means walking away from a sale — is what builds the kind of trust that makes customers loyal for years and refer their friends.",
  },
  {
    id: "obj-6",
    category: "product",
    objection: '"I\'ve heard kratom is addictive or dangerous."',
    wrongResponse: '"No it\'s completely safe, don\'t believe everything you read online."',
    rightResponse:
      '"There is a lot of noise out there about kratom — some of it accurate, some of it not. Here\'s what\'s real: it has a long history of traditional use, and at responsible doses it\'s generally well-tolerated. Daily high-dose use over extended time can create dependence — same as coffee, honestly. That\'s why we always recommend starting low and not leaning on it every single day."',
    whyItWorks:
      "Dismissing someone\'s concern signals that you\'re not trustworthy. Acknowledging the nuance — and giving them the honest version instead of a sales pitch version — is what actually lands. Customers who feel like you gave them the real information buy from you and come back. The coffee dependence comparison normalizes it without minimizing it.",
  },
  {
    id: "obj-7",
    category: "compliance",
    objection: '"Which one is best for getting high?"',
    wrongResponse: "Answering the question directly, or saying \'we don\'t sell it for that purpose\' (which sounds scripted and odd).",
    rightResponse:
      '"I can definitely help you find what you\'re looking for — what kind of effect are you going for? More relaxed and unwinding, or more energized and social? Once I know that I can point you to the right thing."',
    whyItWorks:
      "Never engage with or confirm the \'getting high\' framing — it creates legal exposure. But you also should not make the customer feel weird for asking. The redirect to effect language — relaxed, energized, uplifted, social — is natural and gets you back into a legitimate conversation while still helping them find exactly what they came in for.",
  },
  {
    id: "obj-8",
    category: "price",
    objection: '"Why is the heady glass so much more than a regular piece?"',
    wrongResponse: '"It\'s just nicer quality and more artistic." (vague, doesn\'t justify the gap)',
    rightResponse:
      '"So the scientific glass is machine-assisted, reproducible, and consistent — it\'s a great device. The heady piece is hand-blown by one artist. This specific piece took hours to make and there is not another one exactly like it anywhere in the world. You\'re not buying a device — you\'re buying a one-of-a-kind piece of functional art."',
    whyItWorks:
      "\'Higher quality\' doesn\'t explain a $200-$400 price gap. The one-of-a-kind, hand-made-by-a-specific-artist framing does — because it puts the heady piece in a completely different category. It\'s not a better version of the scientific piece; it\'s a different product entirely. Once that clicks, the price makes sense.",
  },
  {
    id: "obj-9",
    category: "product",
    objection: '"Is THCA flower the same as marijuana? Is this legal?"',
    wrongResponse: '"Yeah it\'s basically the same thing, don\'t worry about it."',
    rightResponse:
      '"So as it sits on the shelf, it\'s federally legal hemp — it tests under the 0.3% Delta-9 threshold required by the 2018 Farm Bill. I can show you the third-party COA on any jar you\'re looking at. It is THCA flower, which means the effects after smoking are similar to what you\'d find at a dispensary — but the product as sold is compliant hemp."',
    whyItWorks:
      "This objection requires legal precision and confidence. Never be vague or dismissive — a confused customer is a non-buying customer and potentially a liability. Citing the Farm Bill, offering to show the COA, and clearly separating \'as sold\' from \'after combustion\' hits every note: reassuring, accurate, and transparent.",
  },
  {
    id: "obj-10",
    category: "hesitation",
    objection: '"I don\'t want to feel too high or overwhelmed."',
    wrongResponse: '"Don\'t worry, it\'s really mild." (minimizing, not informative)',
    rightResponse:
      '"That\'s the most common thing I hear, honestly. The way to make sure that doesn\'t happen is to start with half — whether that\'s half a gummy, half a dose, or just a puff or two. You can always add more. You can\'t take less. And for edibles, wait the full two hours before you decide anything — that gap is where most people get into trouble."',
    whyItWorks:
      "Reassuring with \'it\'s mild\' doesn\'t actually give the customer any control over their experience. Control is what they\'re asking for. Specific guidance — half a dose, two-hour wait, the ability to add more — gives them genuine agency and makes a good first experience significantly more likely. That good experience brings them back.",
  },
]
...
export const languageSwaps: LanguageSwap[] = [
  {
    id: "lang-1",
    context: "Customer asks about or points to a water pipe",
    neverSay: "Bong",
    alwaysSay: "Water pipe",
    reason:
      "\'Bong\' is legally associated with illicit drug paraphernalia and creates direct liability for the store. \'Water pipe\' is the correct retail and legal terminology for all glass filtration pieces. Use it every single time — in conversation, on the floor, and at the register.",
    severity: "critical",
  },
  {
    id: "lang-2",
    context: "Customer picks up or asks about a hand pipe",
    neverSay: "Bowl",
    alwaysSay: "Hand pipe or dry pipe",
    reason:
      "\'Bowl\' used as a standalone noun implies drug paraphernalia use. \'Hand pipe\' or \'dry pipe\' is correct retail terminology. Note: \'bowl\' used in context of describing a water pipe\'s bowl piece (the attachment) is acceptable, but never as the name for the piece itself.",
    severity: "critical",
  },
  {
    id: "lang-3",
    context: "Customer says \'weed,\' \'marijuana,\' \'pot,\' or \'cannabis\' in reference to what they\'re using",
    neverSay: "Weed, marijuana, pot, cannabis (as a drug reference)",
    alwaysSay: "Hemp flower, legal hemp products — or for glass: \'for tobacco\'",
    reason:
      "Our products are sold exclusively for tobacco or legal hemp use. Echoing or affirming illegal drug use terminology in any transaction creates legal exposure. Do not correct the customer directly — just redirect naturally using the correct terms in your own response. They will follow your lead.",
    severity: "critical",
  },
  {
    id: "lang-4",
    context: "Customer asks if a product will get them \'high\' or asks how strong it is",
    neverSay: "\'Yeah this one really gets you high\' or \'It\'s pretty strong, you\'ll definitely feel it\'",
    alwaysSay: "\'This one is more on the relaxing side\' or \'People describe it as uplifted and calm\' or \'It\'s more energizing than sedating\'",
    reason:
      "Confirming \'getting high\' as the intent or purpose of a product creates direct legal exposure. Effect language — relaxed, uplifted, energized, social, calming — describes the experience without framing it as intoxication for illicit purposes. Redirect every time without making the customer feel judged.",
    severity: "critical",
  },
  {
    id: "lang-5",
    context: "Describing kratom effects to a customer",
    neverSay: "\'It\'s like a natural painkiller\' or \'It helps with opioid withdrawal\' or \'It cures anxiety\'",
    alwaysSay: "\'Many customers use it for general wellness and relaxation\' or \'People find it really helps them feel more comfortable and focused\'",
    reason:
      "Medical and disease claims — even casual, informal ones — violate FDA guidelines and create significant regulatory liability. This includes claiming kratom treats pain, anxiety, depression, or withdrawal. All effects must be framed as reported customer experiences, not product promises. There is no exception to this rule.",
    severity: "critical",
  },
  {
    id: "lang-6",
    context: "Customer asks about a dab rig, concentrate pen, or wax product",
    neverSay: "Dab rig, dabs, wax, shatter, BHO, or concentrate pen (for illicit use contexts)",
    alwaysSay: "Concentrate pipe, nectar collector, or \'for use with legal concentrates\'",
    reason:
      "\'Dab\' carries strong legal-grey-area associations in the context of cannabis concentrates. Correct terminology — concentrate pipe, nectar collector — keeps the product in a defensible retail position. Always pair with \'for use with legal concentrates.\'",
    severity: "important",
  },
  {
    id: "lang-7",
    context: "Introducing or describing Kanna to a customer",
    neverSay: "\'It\'s basically a natural antidepressant\' or \'It works just like an SSRI\' or \'It\'s like Prozac for the plant world\'",
    alwaysSay: "\'It works on serotonin pathways, which is why people report an uplifted mood and better focus — but it\'s a dietary supplement, not a medication\'",
    reason:
      "Comparing Kanna to pharmaceutical antidepressants constitutes an implicit medical claim and is inaccurate. Kanna is a dietary supplement and must be sold and described as one. The serotonin pathway mention is factual and informative without making a medication claim — use that framing instead.",
    severity: "important",
  },
  {
    id: "lang-8",
    context: "Any product recommendation conversation",
    neverSay: "\'This will fix your anxiety / treat your depression / cure your insomnia / help your pain\'",
    alwaysSay: "\'A lot of our customers use this for relaxation / sleep support / general wellness / stress relief\'",
    reason:
      "Disease claims — fix, cure, treat, prevent — applied to any supplement or hemp product are strictly prohibited under FTC and FDA guidelines. Always attribute effects to what customers report experiencing, never to what the product does medically. This rule applies to every product in the store without exception.",
    severity: "critical",
  },
  {
    id: "lang-9",
    context: "Selling rolling papers or wraps alongside a glass piece",
    neverSay: "\'Do you want papers to go with that?\' in the same transaction as glass",
    alwaysSay: "Complete the glass transaction, have the customer step outside, then re-enter for the paper transaction separately",
    reason:
      "Glass and rolling papers cannot be sold in the same transaction — this combination is a compliance flag. The customer must exit the store between the two transactions. Explain it matter-of-factly: \'We actually have to ring those separately — just step outside for a second and come right back in.\' Do not explain why in detail.",
    severity: "critical",
  },
  {
    id: "lang-10",
    context: "Discussing THCA flower with any customer",
    neverSay: "\'It\'s basically weed\' or \'It\'s the same as what you get at a dispensary\' or \'It\'s marijuana\'",
    alwaysSay: "\'It\'s federally compliant hemp flower — it tests under the 0.3% Delta-9 threshold required by the 2018 Farm Bill. I can show you the COA on any jar.\'",
    reason:
      "THCA flower is a legally complex product. Calling it weed, marijuana, or \'the same as dispensary cannabis\' is both legally dangerous and technically imprecise for the product as sold. The correct framing — compliant hemp, Farm Bill, COA available — is accurate, confident, and defensible.",
    severity: "critical",
  },
  {
    id: "lang-11",
    context: "Customer discloses they are on an SSRI or antidepressant and wants to buy Kanna",
    neverSay: "\'It should be fine in small amounts\' or \'Just try half\' or downplaying the interaction",
    alwaysSay: "\'I can\'t sell you the Kanna products if you\'re on an SSRI — the interaction can cause real issues. Stick with your current products and talk to your doctor before exploring Kanna.\'",
    reason:
      "Kanna\'s serotonergic mechanism creates a genuine contraindication with SSRIs and SNRIs — this is a hard stop, not a soft caution. There is no dose that makes this safe to recommend. This is a patient safety issue and a store liability issue. Walk away from the sale every time, without exception.",
    severity: "critical",
  },
]
...
export const tipOfTheDay: SalesTip = {
  id: "tod1",
  category: "recommendations",
  title: "The Best Sale You Can Make Is Trust",
  content:
    "Every time you walk away from a sale because it wasn\'t right for the customer — drug test risk, SSRI interaction, wrong product for a first-timer — you make a deposit into a trust account that pays out for years. The customers who feel genuinely taken care of become regulars. They bring friends. They leave reviews. The customers who feel sold to don\'t come back. Protect your customers first. The revenue follows.",
}
